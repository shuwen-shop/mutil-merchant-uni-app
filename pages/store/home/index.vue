		...
		<scroll-view class="main" scroll-y="true" @scroll="scrollHome">
			...
			<view id="store" class="store">
				...
				<view v-if="store.services_type == 1" class="kefu">
					<a :href="'tel:'+store.service_phone" style="color: #fff; text-decoration: none;" class="iconfont icon-kefu3"></a>									
				</view>
				<!-- #endif -->
				<!-- #ifndef H5 -->
			...
			<view class="tab-cont">
				...
				<!--生活服务-->
				<view v-show="tabActive === 2 && service_open" id="product" @touchmove="onTouchmoves">
				...
				<!-- 优惠券 -->
				<view v-show="(tabActive === 3 && service_open) || (!service_open && tabActive === 2)">
				...
				<!--活动专题-->
				<view v-show="tabActive === 4 || (!service_open && tabActive === 3)">
