							...
							<view class="item acea-row row-right">
								<view class="picTxt acea-row row-between-wrapper" @click="godDetail(item)">
									...
									<view class="text">
										...
										<text v-if="item.merchant && item.merchant.type_name" class="font-bg-red mt8">{{item.merchant.type_name}}</text>
										<text v-else-if="item.merchant && item.merchant.is_trader" class="font-bg-red mt8">自营</text>
				...
				<view class="item acea-row row-between-wrapper" v-for="(item, index) in distribution" :key='index' @click="godDetail(item)">
					...
					<view class="text">
						<view class="name line2">
							<text v-if="item.merchant && item.merchant.type_name" class="font-bg-red ml8">{{item.merchant.type_name}}</text>
							<text v-else-if="item.merchant && item.merchant.is_trader" class="font-bg-red ml8">自营</text>
							{{item.store_name}}
						</view>
