				...
				<view class="user-info acea-row">
					...
					<view class="info">		
						<view class="name" v-if="userInfo.uid">
							{{userInfo.nickname}}
						</view> <el-button type="primary" icon="ios-search" label="default" class="mr15" size="small" @click="createUser">创建用户</el-button>
				...
				<view class="upgrade-main">
					<view class="item acea-row row-between-wrapper">
						<view>
							<view class="name">
								签到
								<text class="add">+{{valueList.member_sign_num}}点成长值</text>
							</view>
							<view class="text">每日签到可获得经验值</view>
						</view>
						<navigator class="get_btn" hover-class='none' url='/pages/users/user_sgin/index'>去获取</navigator>
					</view>
					<view class="item acea-row row-between-wrapper">
						<view>
							<view class="name">购买商品<text class="add">+{{valueList.member_pay_num}}点成长值</text></view>
							<view class="text">购买商品可获得对应的成长值</view>
						</view>
						<navigator class="get_btn" open-type='switchTab' hover-class='none' url='/pages/index/index'>去获取</navigator>
					</view>
					<view class="item acea-row row-between-wrapper">
						<view>
							<view class="name">评价商品<text class="add">+{{valueList.member_reply_num}}点成长值</text></view>
							<view class="text">评价商品可获得对应的成长值</view>
						</view>
						<navigator class="get_btn" hover-class='none' url='/pages/users/order_list/index?status=3'>去获取</navigator>
					</view>
					<view class="item acea-row row-between-wrapper">
						<view>
							<view class="name">邀请好友<text class="add">+{{valueList.member_share_num}}点成长值</text></view>
							<view class="text">邀请好友注册商城可获得成长值</view>
						</view>
						<view class="get_btn" @click="shareIntegral">去获取</view>
					</view>
					<view v-if="valueList.member_community_num" class="item acea-row row-between-wrapper">
						<view>
							<view class="name">发布种草<text class="add">+{{valueList.member_community_num}}点成长值</text></view>
							<view class="text">发布一条种草可获得成长值</view>
						</view>
						<navigator class="get_btn" hover-class='none' url='/pages/plantGrass/plant_release/index'>去获取</navigator>
					</view>
				</view>
			</view>
		</view>
			...
			.upgrade{
				...
				.name{
					...
					.add{
						...
						height: 30rpx;
						line-height: 30rpx;
						background: linear-gradient(90deg, #FE8B3D 0%, #FF5E38 100%);
				...
				.get_btn{
					...
					color: #AE6908;
					font-size: 26rpx;
					background: linear-gradient(90deg, #FFDDAC 0%, #EBBD7B 100%);
					border-radius: 26rpx;
				}
			}				
		}
